...
const UI = {
  brandline: L('Elev8 Suite · Guest Relations', 'Elev8 Suite · Guest Relations'),
  ...
  applyAll: L('Alle Elev8-Suite-Angaben werden übernommen …', 'Applying all Elev8 Suite entries …'),
  applied: L('aus Elev8 Suite übernommen', 'taken from Elev8 Suite'),
  ...
  lede: L('Wir übernehmen die Gästekommunikation für Sie. Alles, was in Ihrem Elev8-Suite-Konto schon steht, haben wir bereits eingetragen — Sie bestätigen es nur. Tippen müssen Sie nur das, was in keinem System steht: was unser Guest Relations Officer entscheiden darf, wen er anruft, und wie Sie klingen wollen.',
    'We take over guest communication for you. Everything already in your Elev8 Suite account is filled in — you only confirm it. You only type what no system holds: what our Guest Relations Officer may decide, who to call, and how you want to sound.'),
  waitingOne: L('Angabe kommt aus Elev8 Suite und wartet nur auf Ihr Okay.',
    'entry comes from Elev8 Suite and is only waiting for your go-ahead.'),
  waitingMany: L('Angaben kommen aus Elev8 Suite und warten nur auf Ihr Okay.',
    'entries come from Elev8 Suite and are only waiting for your go-ahead.'),
  ...
  footer: L('Elev8 Suite · Guest Relations Service. Diese Seite ist nur über Ihren persönlichen Link erreichbar und nicht öffentlich auffindbar.',
    'Elev8 Suite · Guest Relations Service. This page is reachable only via your personal link and is not publicly listed.'),

  ok: L('Stimmt', 'Correct'),
  change: L('Ändern', 'Change'),
  yourAnswer: L('Ihre Angabe', 'Your entry'),
  fromElev8Confirmed: L('aus Elev8 Suite, von Ihnen bestätigt', 'from Elev8 Suite, confirmed by you'),
  fromElev8: L('aus Elev8 Suite', 'from Elev8 Suite'),
  required: L('Pflichtangabe', 'Required'),
  confirmSecOne: L('Elev8-Suite-Angabe hier bestätigen', 'Confirm the Elev8 Suite entry here'),
  confirmSecMany: L('Elev8-Suite-Angaben hier bestätigen', 'Confirm the Elev8 Suite entries here'),
  ...
  panelSrc: L('Direkt aus Ihrem Elev8-Suite-Konto', 'Straight from your Elev8 Suite account'),
  panelH: L('Was schon gepflegt ist', 'What is already maintained'),
  panelUnits: L('Einheiten gefunden.', 'units found.'),
  panelLede: L('Diese Angaben mussten Sie nicht eintippen — wir haben sie aus Elev8 Suite gelesen. Sie sehen sie hier nur zur Kontrolle.',
    'You did not have to type these — we read them from Elev8 Suite. They are shown here for checking only.'),
  lastFetched: L('Zuletzt aus Elev8 Suite geholt:', 'Last fetched from Elev8 Suite:'),
  resyncBtn: L('In Elev8 Suite nachgepflegt? Jetzt neu prüfen', 'Updated things in Elev8 Suite? Check again now'),
  resyncBusy: L('Wir sehen in Elev8 Suite nach …', 'Checking Elev8 Suite …'),
  ...
  resyncNone: L('Nichts Neues — in Elev8 Suite steht dasselbe wie vorhin.',
    'Nothing new — Elev8 Suite says the same as before.'),
  ...
  clashH: L('In Elev8 Suite steht inzwischen etwas anderes.', 'Elev8 Suite now says something different.'),
  clashMine: L('Ihre Angabe', 'Your entry'),
  clashTheirs: L('Aus Elev8 Suite', 'From Elev8 Suite'),
  clashTake: L('Elev8-Suite-Wert übernehmen', 'Use the Elev8 Suite value'),
  ...
  newEntries: L('neue Angaben aus Elev8 Suite', 'new entries from Elev8 Suite'),
  newEntry: L('neue Angabe aus Elev8 Suite', 'new entry from Elev8 Suite'),
  ...
  musterPdf: L('Muster als PDF', 'Draft as PDF'),
  viewDraft: L('Entwurf ansehen', 'View draft'),
  notSignableYet: L('Noch nicht unterschreibbar', 'Not ready to sign yet'),
  draftLive: L('Dies ist ein Entwurf aus Ihren bisherigen Angaben. Er wächst mit, solange Sie nichts unterzeichnet haben.',
    'This is a draft built from the entries you have made so far. It keeps updating until you sign.'),
  draftLabel: L('Entwurf', 'Draft'),
  contractsP: L('Aus Ihren Angaben entstehen drei Dokumente. Sie können sie jederzeit als Entwurf ansehen und herunterladen. Unterzeichnet werden sie in der angegebenen Reihenfolge, sobald alles Nötige ausgefüllt ist.',
    'Three documents are generated from your entries. You can view and download them as drafts at any time. They are signed in the order shown, once everything needed is filled in.'),
  ...
  notValidP: L('Bitte fragen Sie bei Ihrem Ansprechpartner bei Elev8 Suite nach einem neuen Link.',
    'Please ask your Elev8 Suite contact for a new link.')
};
