...

  {
    ...
    fields: [
      ...
      { id: 'rm_corridor', type: 'matrix', required: true, contract: true,
        ...
        help: L('Wir haben aus Ihrer Historie und dem Markt einen Vorschlag gerechnet. Der Mindestpreis ist Ihre verbindliche Untergrenze — den verschieben wir nie ohne Ihre Freigabe. Nach oben entscheidet unser Revenue Manager laufend selbst; der Höchstpreis ist ein Ausgangswert.',
          'We have calculated a proposal from your history and the market. The minimum price is your binding floor — we never move it without your approval. Upwards our revenue manager decides on an ongoing basis; the maximum price is a starting value.'),
        columns: [
          ...
          { key: 'max', kind: 'money', label: L('Höchstpreis', 'Maximum price'),
            hint: L('Ausgangswert. An Spitzenterminen gehen wir auch darüber.',
              'Starting value. On peak dates we go above it.') },
